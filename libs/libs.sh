...
# Force a stable C locale on Linux so any chalet/compiler probing here is
# always parseable. (C.UTF-8 keeps UTF-8 path handling; scoped to Linux
# because macOS lacks that locale.)
