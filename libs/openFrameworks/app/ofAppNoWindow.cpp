...
private:
	...
	glm::mat4 getCurrentMatrix(ofMatrixMode) const{ return glm::mat4{ 1.0f }; };
	glm::mat4 getCurrentOrientationMatrix() const{ return glm::mat4{ 1.0f }; }
	...
	glm::mat4 getCurrentViewMatrix() const{ return glm::mat4{ 1.0f }; }
	glm::mat4 getCurrentNormalMatrix() const{ return glm::mat4{ 1.0f }; }
