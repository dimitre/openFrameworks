...
void ofShadow::_drawFrustum( const glm::vec3& aup, const glm::vec3& aright, const glm::vec3& afwd ) {
	...
	ofDrawArrow( data->position, data->position+data->up * 100.0f, 10.0f);
	ofSetColor( ofColor::red );
	ofDrawArrow( data->position, data->position+data->right * 100.0f, 10.0f);
	ofSetColor( ofColor::blue );
	ofDrawArrow( data->position, data->position+data->direction * 100.0f, 10.0f);
