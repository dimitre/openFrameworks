...
ALL_OF_CORE_THIRDPARTY_HEADER_PATHS = $(OF_LIBS_PATH)/$(PLATFORM_LIB_SUBPATH)/include $(OF_LIBS_PATH)/$(PLATFORM_LIB_SUBPATH)/include/freetype2
...
OF_CORE_BASE_CXXFLAGS=$(PLATFORM_CXXFLAGS) -Wfatal-errors
